...
v1_api.register(GiverCountResource())
...
urlpatterns = patterns('',
                       ...
                       url(r'^ourcharities/$', 'giver_app.views.ourcharities', name='ourcharities'),
                       url(r'^new/$', 'charity_app.views.new', name='new'),
                       ...
                       url(r'^charities/(?P<charity_id>\w+)/edit/$', 'charity_app.views.edit_charity',
                           name='edit_charity'),
                       url(r'^charities/(?P<charity_id>\w+)/delete/$', 'charity_app.views.delete_charity',
                           name='delete_charity'),
                       ...
                       url(r'^fbcharities/(?P<fbcharity_id>\w+)/$', 'charity_app.views.fbview_charity',
                           name='fbview_charity'),
                       url(r'^fbcharities/(?P<fbcharity_id>\w+)/edit/$', 'charity_app.views.fbedit_charity',
                           name='fbedit_charity'),
                       url(r'^fbcharities/(?P<fbcharity_id>\w+)/delete/$', 'charity_app.views.fbdelete_charity',
                           name='fbdelete_charity'),
                       ...
                       url(r'^videos/(?P<video_id>\w+)/delete/$', 'charity_app.views.delete_video',
                           name='delete_video'),
                       ...
                       url(r'^fbgivers/(?P<fbgiver_id>\w+)/edit/$', 'giver_app.views.fbedit_giver',
                           name='fbedit_giver'),
                       url(r'^fbgivers/(?P<fbgiver_id>\w+)/delete/$', 'giver_app.views.fbdelete_giver',
                           name='fbdelete_giver'),
                       ...
                       url(r'^analytics/$', 'giver_app.views.analytics', name="analytics"),
